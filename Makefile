...
KERNEL_SRC = kernel/kernel.c kernel/gdt.c kernel/idt.c kernel/isr.c kernel/memory.c kernel/shell.c kernel/kim.c kernel/rootkit.c kernel/syscall.c kernel/process.c kernel/demo_processes.c kernel/process_runner.c drivers/vga.c drivers/keyboard.c drivers/pit.c
...
$(KERNEL_BIN): kernel/kernel.o kernel/gdt.o kernel/idt.o kernel/isr.o kernel/memory.o kernel/shell.o kernel/kim.o kernel/rootkit.o kernel/syscall.o kernel/process.o kernel/demo_processes.o kernel/process_runner.o drivers/vga.o drivers/keyboard.o drivers/pit.o kernel/gdt_flush.o kernel/idt_flush.o kernel/isr_stubs.o kernel/syscall_entry.o kernel/context_switch.o
